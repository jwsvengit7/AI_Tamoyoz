...
class LandingPageState extends State<LandingPage> {
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        // appBar: TamayozLoanAppBar(shouldPop: false,title:""),
        body: Padding(
    ...
    : const Color.fromRGBO(253, 204, 78, 0.2),
            ...
            const  Padding(
                ...
                child:   Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children:[
                      Text("Popular Brands",style: TextStyle(fontSize: 20),),
                      Text("View All", style: TextStyle(fontSize: 15,                                        color: TamayozLoanColors.red1,
                )),
                ...
                child:   Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children:[
                      Text("Special Cars",style: TextStyle(fontSize: 20),),
                      Text("View All", style: TextStyle(fontSize: 15,                                        color: TamayozLoanColors.red1,
                )),
